...
![Blue Pink Modern We Are Hiring Banner](E:\Belief\Blue Pink Modern We Are Hiring Banner.png)

# 📔说明

长期以来收集了很多直投海外找工作的资源，这两天把这些资源整理一下，做个索引。方便自己日后查看，也方便其他有海外工作打算的程序员查阅。欢迎补充，欢迎提 PR~

**欢迎提交 issue 给我你发现的实用资源**
...
可以上 Youtube 搜每个问题，一般都会有人教你回答这个问题的诀窍，什么该说什么不该说
...
最常见的 Mock Interview 平台。邀请3个人可以获得无限 Credits （自己用小号也可以）。
...
### 2.[interview.io](https://interviewing.io)
与大厂程序员进行英文模拟面试

### 3.[Interview Warmup](https://grow.google/certificates/interview-warmup/)
...
### 1. Google Meet 和 Zoom 里开启实时字幕
一般来说跟你面试的单位很有可能就是用这两个来进行会议，而它们是可以开启实时字幕的。这样可以大大降低你的听力负担。

### 2. [iTour](https://www.itourtranslator.com) 
